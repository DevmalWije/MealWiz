...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mealsDict= mapOf(
            ...
            "MealThumb" to "https:\\/\\/www.themealdb.com\\/images\\/media\\/meals\\/sbx7n71587673021.jpg",
            "Tags" to "Sweet",
            ...
            "MealThumb" to "https:\\/\\/www.themealdb.com\\/images\\/media\\/meals\\/atd5sh1583188467.jpg",
            "Tags" to null,
            "Youtube" to "",
            "Ingredient1" to "Rice",
